...
<section>
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<form id="form" action="<c:url value="/admin/business/botaccount/getList" />" method="post" >
				<div class="text-l">
...
<%--					<a href="javascript:;" onclick="member_add('创建三方群组平台','<c:url value="/admin/business/hubgroup/addOrUpdate.html" />','800','')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 创建三方平台</a></span>--%>
<%--				</div>--%>
			<div class="mt-20">
...
$(function(){
	...
	var colModel = [
		...
		{"data": null, "className":"td-manage", "render": function (data, type, row, meta) {
			var itemid = data.id;
			var html = "<a title=\"删除\" href=\"javascript:;\" onclick=\"member_del(this, " + itemid + ",'" + data.name + "')\" class=\"ml-5\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6e2;</i>删除</a>";
			return html;
		}}
	];
	var listAction = "<c:url value="/admin/business/botaccount/getList" />";
