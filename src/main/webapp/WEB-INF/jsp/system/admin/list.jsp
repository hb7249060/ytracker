...
<section>
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 系统管理 <span class="c-gray en">&gt;</span> 管理员管理<a class="btn btn-success btn-refresh radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	<div class="Hui-article">
		<article class="cl pd-20">
			<form id="form" action="<c:url value="/admin/system/admin/getList" />" method="post" >
				<div class="text-l">
<%--					日期范围：--%>
...
$(function(){
	...
	var colModel = [
		...
		{"data": null,"bSortable": false, "render": function (data, type, row, meta) {
			return data.created != null ? datetimeFormat(data.created) : "";
		}},
		{"data": null, "className":"td-manage", "render": function (data, type, row, meta) {
			var itemid = data.id;
			var html = "<a title=\"编辑\" href=\"javascript:;\" onclick=\"member_edit('编辑','<c:url value="/admin/system/admin/addOrUpdate.html" />?id=" + itemid + "'," + itemid + ", '850','')\" class=\"ml-5\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6df;</i>编辑</a>" +
	...
	var listAction = "<c:url value="/admin/system/admin/getList" />";
...
function member_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		layer.prompt({title: '输入您的安全密码', formType: 1}, function(pass, index2){
			var action = '<c:url value='/admin/system/admin/deleteOne/'/>' + id;
			$.ajax({
				url: action,
				type: 'DELETE',
				data: 'secPwd=' + pass,
