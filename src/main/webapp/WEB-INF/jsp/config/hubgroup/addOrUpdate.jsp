...
<article class="cl pd-20">
	<form action="<c:url value='/admin/business/hubgroup/create'/>" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>telegram群组ID：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="telChatId" name="telChatId">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>telegram群组名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="telGroupName" name="telGroupName">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>群内机器人信息：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea id="groupBotInfo" name="groupBotInfo" cols="" rows="" class="textarea"  placeholder="机器人ID-机器人名称，多个回车换行"></textarea>
			</div>
		</div>
		<div class="row cl">
	...
	$(function() {
		...
		if (id != '') {
			...
			$("#form-member-add").attr("action",
					"<c:url value='/admin/business/hubgroup/update'/>");
			$("#id").val(id);
			//根据id取内容
			var action = '<c:url value='/admin/business/hubgroup/getOne/'/>' + id;
			$.ajax({
				url: action,
				type: 'GET',
				data: '',
