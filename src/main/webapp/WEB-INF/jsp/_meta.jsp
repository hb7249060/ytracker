...
<!--[if lt IE 9]>
<script type="text/javascript" src="<c:url value="/static/lib/html5shiv.js" />"></script>
...
<link rel="stylesheet" type="text/css" href="<c:url value="/static/lib/Hui-iconfont/1.0.8/iconfont.css" />" />
