...
<section>
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<form id="form" action="<c:url value="/admin/business/stat/statData" />" method="post" >
				<div class="text-l">
...
function stat(inputStartDate, inputEndDate) {
	...
	var action = '<c:url value='/admin/business/stat/statData'/>';
	$.ajax({
		url: action,
		type: 'post',
		...
		success: function (data) {
			...
			html += "<tr>";
			html += "<td>码商充值积分</td>";
			html += "<td>" + data.rechargePoints + "</td>";
			html += "</tr>";
			html += "<tr>";
			html += "<td>订单数量</td>";
			...
			html += "</tr>";
			html += "<td>收益</td>";
			html += "<td class=\"success\" style='font-weight: bolder;color: #333333;'>￥" + data.profit + " (订单收益" + data.orderProfit + "+代理分润" + data.userProfit + ")</td>";
			html += "</tr>";
			html += "<tr>";
			html += "<td>成功率</td>";
