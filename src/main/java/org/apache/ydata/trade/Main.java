package org.apache.ydata.trade;
...
import org.apache.ydata.trade.config.Configs;
import org.apache.ydata.trade.model.ExtendParams;
import org.apache.ydata.trade.model.GoodsDetail;
import org.apache.ydata.trade.model.builder.*;
import org.apache.ydata.trade.model.hb.*;
import org.apache.ydata.trade.model.result.AlipayF2FPayResult;
import org.apache.ydata.trade.model.result.AlipayF2FPrecreateResult;
import org.apache.ydata.trade.model.result.AlipayF2FQueryResult;
import org.apache.ydata.trade.model.result.AlipayF2FRefundResult;
import org.apache.ydata.trade.service.AlipayMonitorService;
import org.apache.ydata.trade.service.AlipayTradeService;
import org.apache.ydata.trade.service.impl.AlipayMonitorServiceImpl;
import org.apache.ydata.trade.service.impl.AlipayTradeServiceImpl;
import org.apache.ydata.trade.service.impl.AlipayTradeWithHBServiceImpl;
...
//        main.test_trade_precreate();
    ...
    public void test_trade_query() {
        ...
        String outTradeNo = "202405152050182922134";
    ...
    public void test_trade_precreate() {
        ...
        String subject = "测试:xxx品牌xxx门店当面付扫码消费";
...
//        extendParams.setSysServiceProviderId("2088100200300400500");
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
            .setSubject(subject).setTotalAmount(totalAmount).setOutTradeNo(outTradeNo)
                .setNotifyUrl("http://notify.dkjwlsi.xyz/public_bot/callback/aliDmfNotify.htm")
...
//                .setExtendParams(extendParams)
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                String filePath = String.format("/Users/boyer/Downloads/qr-%s.png",
