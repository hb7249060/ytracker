...
<article class="cl pd-20">
	<form action="<c:url value='/admin/business/hubinfo/create'/>" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="apiUrl" name="apiUrl">
			</div>
		</div>
		<div class="row cl">
	...
	$(function() {
		...
		if (id != '') {
			...
			$("#form-member-add").attr("action",
					"<c:url value='/admin/business/hubinfo/update'/>");
			$("#id").val(id);
			//根据id取内容
			var action = '<c:url value='/admin/business/hubinfo/getOne/'/>' + id;
			$.ajax({
				url: action,
				type: 'GET',
				data: '',
